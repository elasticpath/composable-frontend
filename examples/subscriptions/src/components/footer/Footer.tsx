...
const Footer = (): JSX.Element => (
  <div>
    <div className="flex justify-center border-t border-gray-200 bg-white">
      <div className="grid w-full max-w-7xl grid-cols-1 justify-between gap-8 px-4 py-10 sm:grid-cols-2 md:grid-cols-5">
        <div className="flex">
        ...
        <div className="flex items-center justify-end gap-4 self-start">
          <Link
            href="https://github.com/elasticpath/composable-frontend/tree/main/examples/memberships"
