...
import { ProductResponseWithImage } from "src/lib/types/product-types"
...
/**
 * A titled row of product cards. Presentation only — callers fetch the products,
 * so the same strip serves featured products, bundle membership and anything else
 * that has a handful of products to show.
 */
          ...
          return (
            <LocaleLink key={product.id} href={canonicalURL}>
              <li className="relative group">
                ...
                {/* Price is best-effort: a bundle priced per component carries no
                    display price of its own. */}
