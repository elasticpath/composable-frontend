...
import { removeCartPromotionAction } from "../../app/[lang]/(store)/products/[...productSegment]/actions/cart-actions";
...
export function RemoveCartPromotionXButton({ promoCode }: { promoCode: string }) {
  ...
  async function handleRemoveItem() {
    startTransition(async () => {
      try {
        const result = await removeCartPromotionAction({ promoCode });
