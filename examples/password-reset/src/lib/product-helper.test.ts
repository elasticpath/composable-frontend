...
describe("product-helpers", () => {
  test("isChildProductResource should return false if it's a base product", () => {
    const sampleProduct = {
      attributes: {
        base_product: true,
      },
  ...
  test("isChildProductResource should return false if it is a simple product", () => {
    const sampleProduct = {
      attributes: {
        base_product: false,
      },
  ...
  test("isChildProductResource should return true if it is a child product", () => {
    const sampleProduct = {
      attributes: {
        base_product: false,
        base_product_id: "123",
  ...
  test("isSimpleProductResource should return true if it is a simple product", () => {
    const sampleProduct = {
      attributes: {
        base_product: false,
      },
  ...
  test("isSimpleProductResource should return false if it is a base product", () => {
    const sampleProduct = {
      attributes: {
        base_product: true,
      },
  ...
  test("isSimpleProductResource should return false if it is a child product", () => {
    const sampleProduct = {
      attributes: {
        base_product: true,
        base_product_id: "123",
  ...
  test("getSkuIDFromOptions should return the id of the sku for the provided options.", () => {
  ...
  test("getOptionsFromSkuId should return a list of options for given sku id and matrix.", () => {
    const variationMatrixSample = {
      "option-1": {
        "option-3": {
