...
describe("SearchResponseAdapter", () => {
  ...
  //       name: {
  //         value:
  //           "Verizon <mark>Prepaid</mark> - Bring Your Own <mark>Phone</mark> SIM Kit + Airtime",
  //         matchLevel: "full",
  //         matchedWords: ["Prepaid", "Phone"],
  //       },
  //       popularity: {
  ...
  //         const result = subject.adapt()
  //         expect(
  //           result?.renderingContent?.facetOrdering?.facets?.order,
  //         ).toEqual([
  //           "brand",
  //           "free_shipping",
  //           "price",
  ...
  //         expect(
  //           result?.renderingContent?.facetOrdering?.facets?.order,
  //         ).toEqual(["brand", "price", "rating", "free_shipping"])
  //       })
  //     })
  //   })
