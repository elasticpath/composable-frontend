...
describe("get-system-access-token", () => {
  it("getRefreshToken given prod-eu externalId should return correct key", () => {
    expect(
      getRefreshToken(
        "store_prod-eu_f91aa260-4f72-483f-8c65-9bc65e4b4199",
        mockEnvContext
      )
  ...
  it("getRefreshToken given prod-us externalId should return correct key", () => {
    expect(
      getRefreshToken(
        "store_prod-us_f91aa260-4f72-483f-8c65-9bc65e4b4199",
        mockEnvContext
      )
  ...
  it("getRefreshToken given integration externalId should return correct key", () => {
    expect(
      getRefreshToken(
        "store_integration_f91aa260-4f72-483f-8c65-9bc65e4b4199",
        mockEnvContext
      )
    ).toEqual({
      success: true,
  ...
  it("getRefreshToken given staging externalId should return correct key", () => {
    expect(
      getRefreshToken(
        "store_staging_f91aa260-4f72-483f-8c65-9bc65e4b4199",
        mockEnvContext
      )
  ...
  it("getRefreshToken should fail when given invalid environment", () => {
    expectTypeOf(
      getRefreshToken(
        "store_invalid-env_f91aa260-4f72-483f-8c65-9bc65e4b4199",
        mockEnvContext
      )
