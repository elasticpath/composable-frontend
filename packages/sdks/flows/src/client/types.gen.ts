...
export type Entry = {
  ...
  meta?: Meta
  /**
   * Dynamic relationship fields keyed by field slug.
   */
  relationships?: {
    [key: string]: unknown
  }
 ...
 * | `previous` | `null` if you are on the first page. |
...
/**
 * Pagination links returned on list responses.
 *
 * | Property | Description |
 * | --- | --- |
 * | `current` | Always the current page |
...
/**
 * Filter resources using the filter query parameter. See [**Filtering**](/guides/Getting-Started/filtering).
 */
