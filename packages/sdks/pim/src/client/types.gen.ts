...
export type MultiLinks = {
  /**
   * A link to the current page of results. **Note:** this link is not currently returned by PIM endpoints. It will be introduced on or after 1 September 2026.
   *
   */
  current?: string
  /**
  ...
  last?: string
  /**
   * A link to the next page of results. Should be absent on the last page. Currently this is incorrectly absent on the second-to-last page as well; this will be fixed on or after 1 September 2026.
   *
   */
  next?: string
  /**
   * A link to the previous page of results. Should be absent on the first page. Currently this is incorrectly absent on the second page as well; this will be fixed on or after 1 September 2026.
   *
   */
  prev?: string
}
...
export type Errors = {
  ...
  meta: {
    results: {
      /**
       * Total number of job errors for this job.
       */
      total: number
    }
  }
...
export type ProductCustomInputs = {
  [key: string]: {
    ...
    validation_rules?: Array<{
      /**
       * The type of validation rule. For example, `string`.
       */
      type?: string
      /**
...
export type ProductBundleComponents = {
  [key: string]: {
    ...
    options?: Array<{
      ...
      default?: boolean
      /**
       * Whether the product option should be substituted with a child product.
       */
      product_should_be_substituted_with_child?: boolean
      /**
       * The IDs of child products that are excluded from the bundle option.
       */
...
export type FileResponse = {
  data?: Array<{
    ...
    meta?: {
      /**
       * The date and time the file relationship was created.
       */
...
export type MainImageResponse = {
  /**
   * A file object representing the main image, or null if no main image is set.
   */
  data?: {
    /**
  ...
  data?: Array<{
    ...
    meta?: {
      options?: Array<{
        ...
        sort_order?: number
        /**
         * The modifiers associated with this option.
         */
        modifiers?: Array<{
          /**
           * A unique identifier generated when a modifier is created.
           */
          id?: string
          /**
          ...
          value?: string | null
          /**
           * Required for builder modifiers. The sub-string to find and replace.
           */
          seek?: string | null
          /**
           * Required for builder modifiers. The value to replace matches of the seek string.
           */
          set?: string | null
          /**
           * The owner of the modifier, either `organization` or `store`.
           */
          owner?: "organization" | "store"
        }>
      }>
...
export type Hierarchy = {
  ...
  meta: {
    ...
    owner?: "store" | "organization"
    /**
     * Whether the hierarchy has child nodes.
     */
    has_children?: boolean
    /**
     * Breadcrumbs
...
export type DuplicateJob = {
  data: {
    ...
    attributes?: {
      ...
      description?: string
      /**
       * The slug of the duplicate hierarchy. Must be lower case and use dashes instead of spaces.
       */
      slug?: string
      /**
