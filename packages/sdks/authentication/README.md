...
```bash
npm install @epcc-sdk/authentication
# or
pnpm install @epcc-sdk/authentication
# or
yarn add @epcc-sdk/authentication
```
...
```ts
import { client } from "@epcc-sdk/authentication";
...
```ts
import { createClient } from "@epcc-sdk/authentication";
...
You can also pass this instance to any SDK function through the client option. This will override the default instance from `import { client } from "@epcc-sdk/authentication>".
...
```ts
import { createAnAccessToken } from "@epcc-sdk/authentication";

const product = await createAnAccessToken({
