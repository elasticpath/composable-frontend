...
export type AccountsClientOptions = ConfiguredClientOptions<Config>

/**
 * An accounts client with a token source, the `auth` hook and a `fetch` that
 ...
 */
export function createAccountsClient(options: AccountsClientOptions): Client {
