...
export type AuthenticationRealmsClientOptions = ConfiguredClientOptions<Config>

/**
 * An authentication realms client with a token source, the `auth` hook and a
 ...
 */
export function createAuthenticationRealmsClient(
  options: AuthenticationRealmsClientOptions,
): Client {
