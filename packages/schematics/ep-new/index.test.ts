...
describe('EP New Schematic', () => {
  ...
  it('should create files of a workspace', async () => {
    ...
    const tree: any = await schematicRunner.runSchematicAsync('ep-new', options).toPromise().catch((err) => console.log('error caught:', err));
  ...
  it('should create files of an application', async () => {
    ...
    const tree = await schematicRunner.runSchematicAsync('ep-new', options).toPromise();
    const files = tree.files;
  ...
  it('should add packageManager option in angular.json', async () => {
    const tree = await schematicRunner
      .runSchematicAsync('ep-new', { ...defaultOptions, packageManager: 'npm' })
      .toPromise();
