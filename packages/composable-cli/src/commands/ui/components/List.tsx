import { InlineToken, TokenItem, TokenizedText } from "./TokenizedText"
...
const List: FunctionComponent<ListProps> = ({
  ...
  function isCustomListItem(
    item: TokenItem<InlineToken> | CustomListItem,
  ): item is CustomListItem {
  ...
  return (
    <Box flexDirection="column">
      ...
      {items
        .map(resolveListItem)
        .map(({ index, item, color, bullet, ordered }) => (
          <ListItem
            key={index}
            item={item}
            color={color}
