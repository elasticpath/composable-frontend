...
export const errorMessages = {
  ...
  ALREADY_INTEGRATION_INSTANCE: `Already an integration instance for integration ${KLEVU_INTEGRATION_NAME}`,
  EPCC_API_KEYS: `Failed to create EPCC api keys for integration ${KLEVU_INTEGRATION_NAME}`,
  EPCC_API_KEYS_SECRET: "Missing client_secret on response from EPCC api keys.",
  CREATE_INTEGRATION_INSTANCE: `Failed creating an integration instance for ${KLEVU_INTEGRATION_NAME}`,
  DEPLOY_INTEGRATION_INSTANCE: `Failed to deploy integration instsance for ${KLEVU_INTEGRATION_NAME}`,
} as const
