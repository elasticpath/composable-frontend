...
export type Scalars = {
   ...
   */
  DateTime: any;
  /** Represents a JSON serialized string with support for more types. */
  JSONString: any;
  /**
...
export type InstanceExecutionResultsArgs = {
  ...
  id_Contains?: InputMaybe<Scalars['UUID']>;
  instance?: InputMaybe<Scalars['ID']>;
  instance_Customer?: InputMaybe<Scalars['ID']>;
  instance_Integration?: InputMaybe<Scalars['ID']>;
...
export type InstanceDailyUsageMetrics = Node & {
  ...
  failedExecutionCount: Scalars['Int'];
  /** The ID of the object. */
  id: Scalars['ID'];
  ...
  successfulExecutionCount: Scalars['Int'];
};
...
export type RootMutation = {
   ...
   *
   * Access is permitted when any of the following condition(s) are met:
   *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_customers].
   */
   ...
   * Access is permitted when any of the following condition(s) are met:
   *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
   *     2. The signed-in User has any of the following permissions for the associated Customer: [customer_admin_manage_instances, customer_manage_marketplace_integrations].
   */
...
export type DeployInstanceMutation = { __typename?: 'RootMutation', deployInstance?: { __typename: 'DeployInstancePayload', errors?: Array<{ __typename: 'ErrorType', field: string, messages: Array<string> } | null> | null, instance?: { __typename: 'Instance', id: string, name: string, customer: { __typename: 'Customer', id: string, name: string }, integration: { __typename: 'Integration', id: string, name: string, versionNumber: number } } | null } | null };
...
export type CreateInstanceMutation = { __typename?: 'RootMutation', createInstance?: { __typename: 'CreateInstancePayload', instance?: { __typename: 'Instance', id: string, name: string, description: string, labels?: Array<string> | null, customer: { __typename: 'Customer', id: string, name: string }, integration: { __typename: 'Integration', id: string, name: string, versionNumber: number }, configVariables: { __typename?: 'InstanceConfigVariableConnection', nodes: Array<{ __typename?: 'InstanceConfigVariable', id: string, authorizeUrl?: string | null, status?: InstanceConfigVariableStatus | null, value?: string | null, requiredConfigVariable: { __typename?: 'RequiredConfigVariable', dataType: RequiredConfigVariableDataType } } | null> } } | null, errors?: Array<{ __typename: 'ErrorType', field: string, messages: Array<string> } | null> | null } | null };
